...
public class Dataset {
	...
	private MultiURIMapping multiURIMapping;
	...
	public boolean isDatasetURI(String uri) {
		...
		String prefix = multiURIMapping.getPrefix(uri);
		return uri.startsWith(getDatasetBase(prefix)) 
				&& datasetURIPattern.matcher(uri.substring(getDatasetBase(prefix).length())).matches();
	}
	
	public MappedResource getMappedResourceFromDatasetURI(String datasetURI, Configuration configuration) {

		int datasetBaseLength = getDatasetBase(multiURIMapping.getPrefix(datasetURI)).length();
		return new MappedResource(
				escapeURIDelimiters(datasetURI.substring(datasetBaseLength)),
				datasetURI,
				configuration,
				this);
	}
	...
	public MappedResource getMappedResourceFromRelativeWebURI(String relativeWebURI, 
		...
		return new MappedResource(
				relativeWebURI,
				datasetURI, // getDatasetBase() + unescapeURIDelimiters(relativeWebURI),
				configuration,
				this);
	}
	...
	public String getDatasetBase(String prefix) {
